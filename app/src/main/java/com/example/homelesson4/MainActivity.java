       ...
       //выполнение действий при нажатии кнопки
        ...
        private View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (algorithm.isHappyStPetersburg(ticketNumber)) {//если номер билета счастливый,то об этом выводится информация на экран
                ticketInfoOut.setText("Данный номер билета счастливый " + algorithm.nextHappyTicketV1(ticketNumber));
                }else{ //иначе,производится поиск данного билета м последующим выводом на экран
